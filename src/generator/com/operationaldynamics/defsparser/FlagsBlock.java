...
/**
 * Block object representing the .defs data defining a Flag. A flag is like 
 * an enum, but their ordinal values can't be obtained in an automatic way.
 * 
 ...
 * </pre>
 * 
 * Like Enums, all the information needed to define the Java
 * code that will result for a Flag type is in a single (define...)
...
/*
 * TODO
 * I'm using the EnumThing as a FlagThign, cause both are really the same
 * _thing_.
 */
class FlagsBlock extends EnumBlock
{
