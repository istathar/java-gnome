...
public class BoxedBlock extends TypeBlock
{
    /*
     * TODO
     * any reason to make these protected?
     */
     ...
     * definitions define the fields of the underlying C struct wrapped by
     * the boxed.
     * The idea is that we need setXXX and getXXX for each of them to allow
     * java developers access them.
     */
