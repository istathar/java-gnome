 ...
 * 
 * <p>
 * A RadioButton is visually similar to a CheckButton, with the difference its
 * state is shown in a circle instead of an square.
 * 
 * <p>
 ...
 * connect a handler to the ToggleButton's {@link TOGGLED TOGGLED} signal, the
