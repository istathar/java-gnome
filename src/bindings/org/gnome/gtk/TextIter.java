...
public final class TextIter extends Boxed
{
     ...
     */
    /*
     * According to tests, we don't need the boolean return value. (SP) But we
     * might want to keep them for writing loops
     */
     ...
     */
    /*
     * (SP) Inserting an image in a line adds 1 character, but 3 bytes. I
     * don't know why.
     */
