...
/**
 * Renders a Toggle Button into a TreeViewColumn. This CellRenderer may be used 
 * to present boolean data to the user. The fundamental mapping method is 
 * {@link #setActive(DataColumnBoolean) setActive()} which you use to indicate the
 * particular DataColumnBoolean from the underlying TreeModel which will provide
 * the boolean values.
 * 
...
{
    /**
     * Construct a new CellRendererToggle. Specify the TreeViewColumn
     * it will belong to.
     */
    ...
    /**
     * Indicate the DataColumn the state of the CellRendererBoolean is
     * bound to. This is the mapping method you should use if you want to bind
