...
/**
 * This class is a temporary and hyper-thin wrapping of <code>libglade</code>,
 * a library that allows you to transform the XML interface definition files
 * generated by the GNOME User Interface Designers (of which
 * <code>Glade</code> is the original and best known) into live Widgets in
 * your application.
 * 
 * 
 * <p>
 ...
 * name like <code>glade</code> or <code>processedTree</code> for the Xml
 * object you get back, perhaps as follows:
 * 
 * You use <code>libglade</code> as follows:
 * 
 * <pre>
 * final Xml glade;
 * final Window top;
 ...
 * 
 * top = (Window) glade.getWidet(&quot;window1&quot;);
 * confirm = (Button) glade.getWidet(&quot;button4&quot;);
 * </pre>
 * 
 ...
 * 
 * <pre>
 * confirm = (Button) glade.getWidet(&quot;confirmButton&quot;);
 * </pre>
 * 
 ...
 * <code>ClassCastException</code> if you get it wrong.
 ...
 */
/*
 * By extending Glib we force library initialization.
 */
public final class Glade extends Glib
{
     ...
     *            relative FIXME. TODO document how to avoid this problem. A
     *            particularly effective Java solution is to put the
     *            <code>.glade</code> file on your <code>CLASSPATH</code>
     *            and then load the data as an InputStream with ClassLoader's
     *            getResource(), passing the InputStream to the other form of
     *            parse().
     * @param root
     *            the name of the top level Widget whose hierarchy you wish to
     *            load. It turns out you can have serveral Windows and Dialogs
     *            in a single <code>.glade</code> file; because of this you
     *            have to specifiy which Window you want to load. Hopefully
