...
public class ValidateTextBuffer extends TestCaseGtk
{
    ...
    public void testNonPrintable() {
        ...
        buf.insertAtCursor("I need a bunch of lines\n");
        buf.insertAtCursor("This is the second line\n");
        buf.insertAtCursor("and some non-ASCII: הצüß");
        ...
        assertEquals(TextIter.NON_CHARACTER, pointer.getChar());
    ...
    public void testCharsAndBytes() {
        ...
        // UTF-8 for 'הצüß'
        buf.setText("Some umlauts: הצü");
        System.out.println("buf.getText: "+buf.getText());
        assertEquals("Some umlauts: הצü", buf.getText());
//        pointer = buf.getIterStart();
...
//        assertEquals(4, buf.getCharCount());
    ...
    public void testByteAndCharCount() {
        final TextBuffer buf;
        TextIter pointer;
        ...
        assertEquals(5, pointer.getBytesInLine());

        buf.setText("hello\n");
        pointer = buf.getIterStart();
        assertEquals(6, pointer.getCharsInLine());
        assertEquals(6, pointer.getBytesInLine());
